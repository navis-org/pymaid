...
class Volume:
    ...
    @classmethod
    def from_csv(cls, vertices, faces, name=None, color=(1, 1, 1, .1),
                 volume_id=None, **kwargs):
    ...
    @classmethod
    def combine(cls, x, name='comb_vol', color=(1, 1, 1, .1)):
        ...
        if not utils._is_iterable(x) and not isinstance(x, dict):
            raise TypeError('Expected list or dict of Volumes, got {}'.format(type()))
