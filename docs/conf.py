...
import mock
MOCK_MODULES = ['sklearn', 'igraph' , 'tqdm', 'pandas', 'pylab', 'bpy', 'pyoctree', 'PyQt5', 'pyqt5',
                ...
                'matplotlib.externals.six.moves', 'networkx', 'nx', 'requests', 'requests-futures', 'requests.exceptions',
                ...
                'mpl_toolkits.mplot3d.art3d.Line3DCollection','imageio', 'py2cytoscape',
