...
import mock
MOCK_MODULES = ['numpy', 'scipy', 'sklearn', 'matplotlib', 'matplotlib.pyplot', 'igraph' , 'tqdm', 'pandas', 'scipy.spatial', 'scipy.cluster', 
                'pylab', 'math', 'np', 'plt','cluster','spatial','time','logging', 'rpy2', 'ConvexHull', 'http', 'cj','http.cookiejar','re','datetime',
