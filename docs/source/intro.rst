...
Namespace
=========
PyMaid is separated into several modules (e.g. core, plotting, etc.)
...
For the most part, you will just import the main package - this will flatten the namespace. The following is equivalent to above example:
